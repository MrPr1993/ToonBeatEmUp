...
if AnimFrame>6.7 {canmove=1 anim=0}
	...
	projectile_create(x+42*image_xscale,y,z-57,-8,spr_bullet,weaponProjSpr,weaponProjSpd*image_xscale,weaponProjMask,weaponProjHitSpr,weaponDamage,weaponHitType,weapontargetHeight,0,0)
	projectile.spdZ=2 projectile.HitSound=weaponProjHitSnd
	}	
...
with flame	{z=-57 image_speed=0.5 sprite_index=spr_robot_ice alarm[0]=0}
	...
	{
	flame=instance_create_depth(x+38*image_xscale,y,depth,oFlashFX) flame.image_xscale=image_xscale
with flame	{z=-57 image_speed=0.5 sprite_index=spr_robot_ice image_index=4 alarm[0]=0}
	}}		
		 else atk=0
		 if AnimFrame=2
		 {
