...
draw_feat(12,spr_featicon,12,c_white,"Wolf Whisperer","Defeat Lady Wolf without taking damage.")
draw_feat(13,spr_featicon,13,c_white,"Singing Fat Lady","Defeat Harpilda without taking damage.")
draw_feat(14,spr_featicon,14,c_white,"We Can Do It","Defeat Captain Rosy without taking damage.")
draw_feat(15,spr_featicon,15,c_white,"Double Header","Defeat Dolores without taking damage.")
draw_feat(16,spr_featicon,16,c_white,"Off With Her Head","Defeat Annamari without taking damage.")
draw_feat(17,spr_featicon,17,c_white,"Divine Punishment","Defeat Hathor without taking damage.")
draw_feat(18,spr_featicon,18,c_white,"Oni Jackpot","Defeat The Oni Sisters without taking damage.")
draw_feat(19,spr_featicon,19,c_white,"Swamped Out","Defeat Kiandra without taking damage.")
draw_feat(20,spr_featicon,20,c_white,"Daffy Amuck","Defeat Dixie without taking damage.")
draw_feat(21,spr_featicon,21,c_white,"Beached Witch","Defeat Circe without taking damage.")
draw_feat(22,spr_featicon,22,c_white,"Spaced Out","Defeat Kuinn without taking damage.")
draw_feat(23,spr_featicon,23,c_white,"Watered Prince","Defeat Prince without taking damage.")
draw_feat(24,spr_featicon,24,c_white,"Wished Beating","Defeat Haifa without taking damage.")
draw_feat(25,spr_featicon,25,c_white,"All Shattered","Defeat Mirrosa without taking damage.")
draw_feat(26,spr_featicon,26,c_white,"Royally Planted","Defeat Synthesa without taking damage.")
