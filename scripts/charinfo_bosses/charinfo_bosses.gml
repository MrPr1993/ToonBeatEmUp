...
idlestyle=3
 ...
 "She’s big. She’s round. She has a song in her heart. A fight with her won't be over until the fat lady sings.") break;

case 3:enemyID=153
idlestyle=1
 charinfo_set(12,spr_franki_stand,1,animsetup_enemy,draw_enemy,spr_boxerpal,0,spr_enemyface,10,"CAPTAIN ROSY",
 "A colossal woman who ferries passengers on her beloved ship. Stowaways will be in for a shock in more ways than one.") break;
 
 case 4:enemyID=154
charinfo_set(12,spr_twoheads_stand,1,animsetup_enemy,draw_enemy,spr_enemypal,0,spr_enemyface,35,"DOLORES",
 "This cowgirl in charge of the Loco Dos hunts down stowaways. Two heads, and guns, are better than one.") break;

 case 5:enemyID=155
 charinfo_set(12,spr_ghost_stand,1,animsetup_enemy,ghost_effect,spr_enemypal,0,spr_enemyface,17,"ANNAMARI",
 "A head collector in life. She became a ghost after taking her own head. She may enjoy beheadings a bit too much...") break;
  
  case 6:enemyID=156
  idlestyle=1
 charinfo_set(12,spr_pharaoh_stand,1,animsetup_enemy,draw_enemy,spr_enemypal,0,spr_enemyface,11,"HATHOR",
 "A goddess who enjoys a good party. But those who disrespect her will be met with some good old fashioned divine punishment.") break;
   case 7:enemyID=157
     hasVariants=1
  if dataPal=1
 ...
 "She dwells in the swamp alone with the undead as she stirs her cauldron. She’s a druid, not a witch. Don’t mix it up…") break;
   case 9:
   enemyID=160
 charinfo_set(12,spr_duck_stand,1,animsetup_enemy,draw_enemy,spr_enemypal,0,spr_enemyface,39,"DIXIE",
 "The carnival's crazy ringmaster. She’s a cartoon duck toy person... thing. She’s quite the quack.") break;
...
break;
 ...
 "A cave dwelling sea witch who enjoys company so long as they don't cause trouble. Otherwise, they get a spankin'.") break;
   case 12: enemyID=163
 charinfo_set(12,spr_martianb_stand,1,animsetup_enemy,draw_enemy,spr_enemypal,0,spr_enemyface,54,"KWINN",
 "She is the captain of a space pirate crew! And they’ll crush anyone in their way with their out of this world technology!") break;
   case 13: enemyID=164
...
idlestyle=1 hasVariants=1
 ...
 "A genie of the lamp who willingly listens to her master as she crushes intruders. How deep is her devotion?") break;
...
idlestyle=1
 ...
 "A pretty plant who rules the fantastical depths of the caverns. This party loving plant princess won’t let you leave anytime soon...") break;
     case 18: enemyID=174
idlestyle=1
 charinfo_set(12,spr_dragonmaiden_head,1,animsetup_enemy,draw_enemy,spr_enemypal,0,spr_enemyface,56,"FIONA",
 "A maiden from the clouds looking for true love. But failing to find suitors keeps her in a terrible mood.") break;
     case 19: enemyID=175
...
idlestyle=1
 ...
 "I don't understand… I have no recorded info on this subject… Who is she? What is she? Where’d she even come from?!") break;
}
