...
///Gamepad
ini_write_real("gpCONTROLST"+string(_controlno), "0", global.gpControlAttack[_controlno])
ini_write_real("gpCONTROLST"+string(_controlno), "1", global.gpControlCharge[_controlno])
ini_write_real("gpCONTROLST"+string(_controlno), "2", global.gpControlRelease[_controlno])
ini_write_real("gpCONTROLST"+string(_controlno), "3", global.gpControlJump[_controlno])
ini_write_real("gpCONTROLST"+string(_controlno), "4", global.gpControlJumpH[_controlno])
ini_write_real("gpCONTROLST"+string(_controlno), "5", global.gpControlShield[_controlno])
ini_write_real("gpCONTROLST"+string(_controlno), "6", global.gpControlShieldP[_controlno])
ini_write_real("gpCONTROLST"+string(_controlno), "7", global.gpControlSuper[_controlno])
ini_write_real("gpCONTROLST"+string(_controlno), "8", global.gpControlTaunt[_controlno])
ini_write_real("gpCONTROLST"+string(_controlno), "9", global.gpControlPunchback[_controlno])
ini_write_real("gpCONTROLST"+string(_controlno), "10", global.gpControlInteract[_controlno])
}