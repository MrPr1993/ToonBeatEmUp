...
function animsetup_sofia_misc() {
	...
	{if key_jump {featno[2]+=1; if featno[2]>=8 feats_check(52) z=en.z-en.headPosY[en.GrabFrame] PlaySound(snd_sofia3) AnimFrame=0 anim=3 zSpeed=-8 image_index=0 flashFX(x,y,z,spr_hitflash,0,1,0,1,1,c_white,1)
	...
	zSpeed=0 sentflying=0 AnimFrame=0.01 wobbleX=1.2 wobbleY=0.7
