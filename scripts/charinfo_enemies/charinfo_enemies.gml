...
break;
  case 9:
  idlestyle=1
 charinfo_set(14,spr_wrestler_stand,0,animsetup_enemy,draw_enemy,spr_ninjapal,2,spr_enemyface,19,"MS.SLAMS",
...
"Painting.")
    ...
    if dataPal=2
	{paintingSpr=spr_painting2
 charinfo_set(12,spr_painting_base,3,animsetup_enemy,painting_draw,spr_zombiepal,0,spr_miscface,0,"PAINTING",
"Painting.")	}
	    if dataPal=3
		{paintingSpr=spr_painting3
 charinfo_set(12,spr_painting_base,3,animsetup_enemy,painting_draw,spr_zombiepal,0,spr_miscface,0,"PAINTING",
"Painting.")}
break;
  case 18:
...
break;
 ...
 charinfo_set(12,spr_clown_stand,3,animsetup_enemy,draw_enemy,spr_bearpal,0,spr_enemyface,38,"ANETTE",
...
"An adorable plush of fluff who can teach naughty people how to treat them nice. With their fists.")
 ...
 break;
 case 24: hp=0.25
 charinfo_set(12,spr_fairy_stand,3,animsetup_enemy,draw_enemy,spr_fairypal,0,spr_miscface,0,"BELLE",
...
weapon_add("HARPOONGUN")
 charinfo_set(12,spr_diver_stand,2,animsetup_enemy,draw_enemy,spr_ninjapal,0,spr_enemyface,45,"MR.DIVE",
"An underwater minion who seeks for their foes under the sea and rob of the treasures. An underwater chump.")
  if dataPal=2 {enemy_switch("MR.DROP",0)}
