...
if weaponspr2!=-1 and weaponBack2=1
{
if image_alpha<1
draw_sprite_ext(weaponspr2,weaponIndex2,round(x+((floorPosX[image_index]*floorPos+waistPosX[image_index]*waistPos+headPosX[image_index])*SpritePos)*image_xscale+(shake+weaponX2*wobbleX)*image_xscale),round(y+trainz+(floorPosY[image_index]+waistPosY[image_index]+headPosY[image_index])*SpritePos+weaponY2*wobbleY+z+extraY),image_xscale,image_yscale,(weaponangle2*image_xscale)+weaponExtraAngle*image_xscale,c_black,1)

pal_swap_set(weapon_pal_sprite,weapon_pal,false);

draw_sprite_ext(weaponspr2,weaponIndex2,round(x+((floorPosX[image_index]*floorPos+waistPosX[image_index]*waistPos+headPosX[image_index])*SpritePos)*image_xscale+(shake+weaponX2*wobbleX)*image_xscale),round(y+trainz+(floorPosY[image_index]+waistPosY[image_index]+headPosY[image_index])*SpritePos+weaponY2*wobbleY+z+extraY),image_xscale,image_yscale,(weaponangle2*image_xscale)+weaponExtraAngle*image_xscale,weaponcolor2,image_alpha)
...
if weaponspr2!=-1 and weaponBack2=0
{
if image_alpha<1
draw_sprite_ext(weaponspr2,weaponIndex2,round(x+((floorPosX[image_index]*floorPos+waistPosX[image_index]*waistPos+headPosX[image_index])*SpritePos)*image_xscale+(shake+weaponX2*wobbleX)*image_xscale),round(y+trainz+(floorPosY[image_index]+waistPosY[image_index]+headPosY[image_index])*SpritePos+weaponY2*wobbleY+z+extraY),image_xscale,image_yscale,(weaponangle2*image_xscale)+weaponExtraAngle*image_xscale,c_black,1)
