...
///Ms. Swing
case "MS.TRIG": enemy_modify(spr_swingpal,10,_name,0,0.2,0.2) enemyID=21 break; ///UNUSED
...
case "MS.BRAN": enemy_modify(spr_swingpal,4,_name,0,0.3,0.3) enemyID=24 break;
