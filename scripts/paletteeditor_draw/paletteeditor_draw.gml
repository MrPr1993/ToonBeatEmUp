...
draw_sprite(customadd,0,0,0)	

//draw_sprite_ext(customadd,0,0,64,2,2,0,c_white,1-0.5*SelectChar)

matrix_set(matrix_world,matrix_build(48,16,0,0,0,0,6,6,1))
draw_sprite_part_ext(customadd,0,1,0,32,24,1,0,1,1,c_white,1-0.5*SelectChar)	

draw_sprite_part_ext(customadd,0,0,0,1,24,-1,0,1,1,c_white,1-0.5*SelectChar)	
...
pal_swap_set(customadd,current_pal,false);
...
draw_set_color(c_white) draw_text(320-33,160-120,name)
...
//draw_sprite_part_ext(customadd,0,0,0-1+1*paletterow,1,1*paletterow,1*current_pal,(1*paletterow),1,1,c_white,1)
surface_save_part(application_surface,"Special/customreset.png",0,0,32,24)
sprite_replace(customadd,"Special/customreset.png",0,0,0,0,0)
}
