...
if global.AllStageModeUnlock ///Y
if global.SaveNumber=0 and global.MenuGlobal=0
draw_buttontext_ext(8,240-(20+16),8,"",spr_commandbutton,0,"Y",commandL[23],0.75,1,1,1,0.75,1.0)
}
}
...
if global.AllStageModeUnlock ///Y
if global.SaveNumber=0 and global.MenuGlobal=0
draw_buttontext_ext(8,240-36,8,"",spr_commandbutton,8+6*commandMul,"",commandL[23],0.75,1,1,1,0.75,1.0)	
