...
if dataSet=0
{
draw_charinfoicon(1,spr_enemyface,1,24,unlockedChar[1])
draw_charinfoicon(2,spr_enemyface,2,24*2,unlockedChar[2])
draw_charinfoicon(3,spr_enemyface,3,24*3,unlockedChar[3])
draw_charinfoicon(4,spr_enemyface,4,24*4,unlockedChar[4])
draw_charinfoicon(5,spr_enemyface,5,24*5,unlockedChar[5])
draw_charinfoicon(6,spr_enemyface,6,24*6,unlockedChar[6])
}
else
if dataSet=-144
{
draw_charinfoicon(7,spr_enemyface,7,24*7,unlockedChar[7])
draw_charinfoicon(8,spr_enemyface,8,24*8,unlockedChar[8])
draw_charinfoicon(9,spr_enemyface,9,24*9,unlockedChar[9])
draw_charinfoicon(10,spr_enemyface,10,24*10,unlockedChar[10])
draw_charinfoicon(11,spr_enemyface,11,24*11,unlockedChar[11])
draw_charinfoicon(12,spr_enemyface,12,24*12,unlockedChar[12])
}
else
if dataSet=-144*2
{
...
if dataRow=2 or dataRow=3
draw_sprite_ext(spr_playerface,0,0,26,1,1,0,c_white,1)
draw_set_alpha(1)
}
shader_reset()
...
draw_text_transformed(146-144,32+26+4,descleft,0.75,1,0) //Name
draw_text_transformed(146-144,32+26+32+8+4,descright,0.75,1,0) //Name
...
draw_text_ext(tex_start_x+146+2-144-4,tex_start_y+32+52+32+8,desc,8,136) //Description 188
draw_text_ext_transformed(4,240-24,dataabilities,8,102,0.75,1,0)
