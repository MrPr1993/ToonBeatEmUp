...
if dataSet=-144*2
{
draw_charinfoicon(13,spr_enemyface,64,24*13,c_white*global.UnlockEnemy[130])
draw_charinfoicon(14,spr_enemyface,13,24*14,c_white*global.UnlockEnemy[39])
draw_charinfoicon(15,spr_enemyface,14,24*15,c_white*global.UnlockEnemy[42])
draw_charinfoicon(16,spr_enemyface,21,24*16,c_white*global.UnlockEnemy[45])
draw_charinfoicon(17,spr_enemyface,65,24*17,c_white*global.UnlockEnemy[133])
draw_charinfoicon(18,spr_miscface,0,24*18,c_white*global.UnlockEnemy[47])
}
else
if dataSet=-144*3
{
draw_charinfoicon(19,spr_miscface,0,24*19,c_white*global.UnlockEnemy[48])
draw_charinfoicon(20,spr_enemyface,12,24*20,c_white*global.UnlockEnemy[51])
draw_charinfoicon(21,spr_enemyface,24,24*21,c_white*global.UnlockEnemy[53])
draw_charinfoicon(22,spr_enemyface,15,24*22,c_white*global.UnlockEnemy[55])
draw_charinfoicon(23,spr_enemyface,16,24*23,c_white*global.UnlockEnemy[58])
draw_charinfoicon(24,spr_enemyface,38,24*24,c_white*global.UnlockEnemy[60])
}
else
if dataSet=-144*4
{
draw_charinfoicon(25,spr_enemyface,49,24*25,c_white*global.UnlockEnemy[63])
draw_charinfoicon(26,spr_enemyface,53,24*26,c_white*global.UnlockEnemy[69])
draw_charinfoicon(27,spr_enemyface,29,24*27,c_white*global.UnlockEnemy[72])
draw_charinfoicon(28,spr_enemyface,63,24*28,c_white*global.UnlockEnemy[117])
draw_charinfoicon(29,spr_enemyface,42,24*29,c_white*global.UnlockEnemy[75])
draw_charinfoicon(30,spr_enemyface,50,24*30,c_white*global.UnlockEnemy[77])
}
else
if dataSet=-144*5
{
draw_charinfoicon(31,spr_enemyface,45,24*31,c_white*global.UnlockEnemy[80])
draw_charinfoicon(32,spr_enemyface,25,24*32,c_white*global.UnlockEnemy[82])
draw_charinfoicon(33,spr_enemyface,26,24*33,c_white*global.UnlockEnemy[85])
draw_charinfoicon(34,spr_enemyface,23,24*34,c_white*global.UnlockEnemy[88])
draw_charinfoicon(35,spr_enemyface,28,24*35,c_white*global.UnlockEnemy[90])
draw_charinfoicon(36,spr_enemyface,43,24*36,c_white*global.UnlockEnemy[93])
}
else
if dataSet=-144*6
{
draw_charinfoicon(37,spr_enemyface,27,24*37,c_white*global.UnlockEnemy[95])
draw_charinfoicon(38,spr_enemyface,52,24*38,c_white*global.UnlockEnemy[97])
draw_charinfoicon(39,spr_enemyface,22,24*39,c_white*global.UnlockEnemy[101])
draw_charinfoicon(40,spr_enemyface,51,24*40,c_white*global.UnlockEnemy[107])
draw_charinfoicon(41,spr_enemyface,48,24*41,c_white*global.UnlockEnemy[110])
draw_charinfoicon(42,spr_enemyface,46,24*42,c_white*global.UnlockEnemy[114])
...
if dataSet=-144*3
{
draw_charinfoicon(19,spr_enemyface,36,24*19,c_white*global.UnlockEnemy[175])
draw_charinfoicon(20,spr_enemyface,18,24*20,c_white*global.UnlockEnemy[177])
