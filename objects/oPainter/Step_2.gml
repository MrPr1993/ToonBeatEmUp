...
if anim=11
{damage=0.2 selfatk.isCut=1 selfatk.spriteFX=spr_blood
...
frame_set(3,3,0.05) if AnimFrame=clamp(AnimFrame,2,3) atk=1 else atk=0
frame_set(4,4,0.25)
if AnimFrame>4.70 {canmove=1 anim=0}
}
...
frame_set(0,0,0.25)
frame_set(1,1,0.25) if AnimFrame=2 {ground=0 spdZ=-8 sentflying=8*image_xscale}
frame_set(2,2+specialtimes[0],0.5) if !ground {AnimFrame=2.5} else if AnimFrame=2.5
...
if AnimFrame>13.70 {canmove=1 anim=0}
}
