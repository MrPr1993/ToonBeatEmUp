...
{
if spawned=1
pal_swap_set(spr_horsepal,horsepal,false);
else
...
{
pal_swap_set(my_pal_sprite,current_pal,false);
draw_sprite_ext(riderSpr,image_index,round(x-image_index),round(y+z-image_index),image_xscale,image_yscale,0,image_blend,image_alpha)
pal_swap_reset();
shader_reset()
}
}
