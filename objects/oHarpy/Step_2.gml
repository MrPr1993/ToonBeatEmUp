...
if atkBuffer2!=0 atkBuffer2-=1

if anim=10
{animFrame=0 canmove=0 specialcheck0=0
if atkBuffer1=0 {atkBuffer1=choose(380,390,400,410) atkBuffer2=choose(380,390,400,410) anim=13 exit;}
if atkBuffer2=0 {atkBuffer1=choose(380,390,400,410) atkBuffer2=choose(380,390,400,410) anim=14 exit;}
...
if animFrame=clamp(animFrame,2,6) {atk=1 sentflying=8*image_xscale image_index+=0.25 if image_index=4.75 image_index=1} else {atk=0 image_index=0 sentflying=lerp(sentflying,0,0.5)}
...
if anim=13 ///Sing
	...
	if anim=14 ///Wings
	{if animFrame=0 PlaySound(snd_harpy9)
