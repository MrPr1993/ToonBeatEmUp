...
//if playerNO=1 oControl.altresult2a=fishname
//if playerNO=2 oControl.altresult2b=fishname
//if playerNO=3 oControl.altresult2c=fishname
//if playerNO=4 oControl.altresult2d=fishname
