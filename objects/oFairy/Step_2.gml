...
if current_pal=1 or current_pal=3 anim=14
...
MoveType=1 damage=0.15
	...
	if AnimFrame=2 {ground=0 sentflying=4*image_xscale zSpeed=-4 PlaySoundNoStack(snd_swing)}
...
if AnimFrame>4.5 canmove=1
	...
	{ground=0 sentflying=1.5*image_xscale zSpeed=-10 PlaySoundNoStack(snd_swing2)
