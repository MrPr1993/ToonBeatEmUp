...
x+=4*image_xscale
sprite_index=spr_croc image_speed=0.5 

if BounceOnce=1 {image_speed=0 var targeten=instance_nearest(x,y,oPlayer); if point_distance(x-32,0,targeten.x-32,0)<140
		{zSpeed=-8 image_speed=0.5 BounceOnce=0
		}
	}
