...
if key_attack {meter+=0.9/4} meter-=0.45/64 meter=clamp(meter,0,1)
...
//y=lerp(y,ystart+(source1)*toweramount*(32+1),1)
	
slotSpd+=1 slotSpd=clamp(slotSpd,-32,32) slotY+=slotSpd
if slotY>((((strtotal)/maxpoints))*(maxpoints))-1000// or slotY>(toweramount*32)*toweramount
{
