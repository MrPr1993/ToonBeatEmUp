...
{brickgamenum+=1
p2=instance_create_depth(190,168+8*instance_number(oBullPlayer),-1,oBullPlayer) with p2
{
...
{brickgamenum+=1
p3=instance_create_depth(190,168+8*instance_number(oBullPlayer),-1,oBullPlayer) with p3
{
...
{brickgamenum+=1
p4=instance_create_depth(190,168+8*instance_number(oBullPlayer),-1,oBullPlayer) with p4
{
...
if brickgamenum=1 with oBullPlayer y+=24
if brickgamenum=2 with oBullPlayer y+=16
if brickgamenum=3 with oBullPlayer y+=8
if brickgamenum=4 with oBullPlayer y+=0
...
with oBullPlayer canControl=0 alarm[0]=240