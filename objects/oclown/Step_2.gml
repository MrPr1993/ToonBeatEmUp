...
weaponanim_2(weaponspr,weaponIndex,-17,-86,439,weaponcolor)}
	if image_index=clamp(image_index,1,1.9)
{weaponanim(weaponspr,weaponIndex,18,-56,443,weaponcolor)
weaponanim_2(weaponspr,weaponIndex,-29,-78,453,weaponcolor)}
	if image_index=clamp(image_index,2,2.9)
{weaponanim(weaponspr,weaponIndex,44,-47,356,weaponcolor)
weaponanim_2(weaponspr,weaponIndex,-16,-84,464,weaponcolor)}
	if image_index=clamp(image_index,3,3.9)
{weaponanim(weaponspr,weaponIndex,44,-72,439,weaponcolor)
weaponanim_2(weaponspr,weaponIndex,-28,-68,456,weaponcolor)}
	}
...
weaponanim_2(weaponspr,weaponIndex,-28,-73,459,weaponcolor)}
		if image_index=clamp(image_index,1,1.9)
{weaponanim(weaponspr,weaponIndex,32,-75,463,weaponcolor)
weaponanim_2(weaponspr,weaponIndex,-15,-91,449,weaponcolor)}
		if image_index=clamp(image_index,2,2.9)
{weaponanim(weaponspr,weaponIndex,13,-79,509,weaponcolor)
weaponanim_2(weaponspr,weaponIndex,-33,-62,491,weaponcolor)}
		if image_index=clamp(image_index,3,3.9)
{weaponanim(weaponspr,weaponIndex,13,-77,509,weaponcolor)
weaponanim_2(weaponspr,weaponIndex,-32,-61,491,weaponcolor)}
...
weaponanim_2(weaponspr,weaponIndex,-26,-67,86,weaponcolor)}
if image_index=clamp(image_index,1,1.9)
{weaponanim(weaponspr,weaponIndex,35,-86,86,weaponcolor)
weaponanim_2(weaponspr,weaponIndex,-25,-67,86,weaponcolor)}
if image_index=clamp(image_index,2,2.9)
{weaponanim(weaponspr,weaponIndex,33,-86,86,weaponcolor)
weaponanim_2(weaponspr,weaponIndex,-27,-68,86,weaponcolor)}
...
weaponanim_2(weaponspr,weaponIndex,-31,-64,93,weaponcolor)}
if image_index=clamp(image_index,1,1.9)
{weaponanim(weaponspr,weaponIndex,31,-88,93,weaponcolor)
weaponanim_2(weaponspr,weaponIndex,-30,-74,90,weaponcolor)}
if image_index=clamp(image_index,2,2.9)
{weaponanim(weaponspr,weaponIndex,33,-76,102,weaponcolor)
weaponanim_2(weaponspr,weaponIndex,-23,-88,81,weaponcolor)}
if image_index=clamp(image_index,3,3.9)
{weaponanim(weaponspr,weaponIndex,33,-71,109,weaponcolor)
weaponanim_2(weaponspr,weaponIndex,-15,-90,74,weaponcolor)}
if image_index=clamp(image_index,4,4.9)
{weaponanim(weaponspr,weaponIndex,33,-79,103,weaponcolor)
weaponanim_2(weaponspr,weaponIndex,-20,-90,79,weaponcolor)}
if image_index=clamp(image_index,5,5.9)
{weaponanim(weaponspr,weaponIndex,34,-82,97,weaponcolor)
weaponanim_2(weaponspr,weaponIndex,-26,-78,84,weaponcolor)}
