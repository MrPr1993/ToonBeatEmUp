...
specialtimes[1]=-1*(point_distance(x,0,targetX,0)/30)

}
	
frame_set(0,0,0.25)
frame_set(1,1,0.1)
frame_set(2,3,0.25) if animFrame=3 {
...
sprite_index=spr_beelady_attack1
frame_set(0,0,0.01)
frame_set(1,1,0.25) if animFrame=2 flashFX(x+42*image_xscale,y+1,z-32,spr_sparkflash,0,0.25,10,1,1,c_white,1)
frame_set(2,2,0.25) 
frame_set(3,3+specialtimes[0],0.01)
frame_set(4,4,0.01) if animFrame=clamp(animFrame,3,4) {sentflying=8*image_xscale atk=1} else {sentflying=0 atk=0}
frame_set(5,1,0.25)
