...
{brickgamenum+=1
p1=instance_create_depth(0,53,-1,oSingPlayer) with p1
{
oSingGame.p1Over=0	
canControl=1
...
{brickgamenum+=1
p2=instance_create_depth(80*instance_number(oSingPlayer),53,-1,oSingPlayer) with p2
{
oSingGame.p2Over=0	sprite_index=spr_hina_brick 
canControl=1
...
{brickgamenum+=1
p3=instance_create_depth(80*instance_number(oSingPlayer),53,-1,oSingPlayer) with p3
{
oSingGame.p3Over=0	sprite_index=spr_bahati_brick
canControl=1 
...
{brickgamenum+=1
p4=instance_create_depth(80*instance_number(oSingPlayer),53,-1,oSingPlayer) with p4
{
oSingGame.p4Over=0	sprite_index=spr_sofia_brick
canControl=1
...
if brickgamenum=1 with oSingPlayer x+=160-40
if brickgamenum=2 with oSingPlayer x+=160-80
if brickgamenum=3 with oSingPlayer x+=160-120
if brickgamenum=4 with oSingPlayer x+=0
