...
{
projectile_create(x+6*image_xscale,y,z-61+8,32,spr_ladybot_rocket,4*image_xscale,mask_small,spr_explosion4,0.25,5,5,4,-4)
projectile.HitSound=snd_explosion2
dust_make(x+6*image_xscale,y+1,z-64,0,0,0)
