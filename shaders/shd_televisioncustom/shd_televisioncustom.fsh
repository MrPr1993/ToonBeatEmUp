...
void main()
{
   ...
   vec3 sepia = vec3(0.0); 
     vec4 colour = gl_FragColor = vec4(mul_res, 1.0);
    sepia.r = dot(colour.rgb, vec3(0.784313725*customR, 0.788235294, 0.262745098));
    sepia.g = dot(colour.rgb, vec3(0.490196078, 0.521568627*customG, 0.152941176));
    sepia.b = dot(colour.rgb, vec3(0.0, 0.415686275*customB, 0.0));
