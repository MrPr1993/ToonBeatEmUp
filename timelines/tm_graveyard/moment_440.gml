...
{
en5=instance_create_depth(__view_get( e__VW.XView, 0 )-16,210,0,oSkeleton) with en5
{image_xscale=-1 canAttack=5 alarm[3]=30
	current_pal=1 //name="ZOMBOBBY" enemy_switch("ZOMBOBBY",0)
	}
en6=instance_create_depth(__view_get( e__VW.XView, 0 )-16,190,0,oSkeleton) with en6
{image_xscale=-1 canAttack=5 alarm[3]=30
	current_pal=1 enemy_switch("SKELIE",0) //name="ZOMBELLE" enemy_switch("ZOMBELLE",0)
	}

////
if playernumber>=2 {P2en1=instance_create(__view_get( e__VW.XView, 0 )+320+32, 200,oSkeleton)
with P2en1 {canAttack=5 alarm[1]=30 enemy_switch("SKELIE",0) image_xscale=-1}}
...
with P2en3 {canAttack=5 alarm[1]=30 enemy_switch("SKELIE",0) image_xscale=-1}}
////
}
else
{
