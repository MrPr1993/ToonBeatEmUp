...
with en4 {image_xscale=1 canAttack=5 enemy_modify(my_pal_sprite,1,"DESTRON",0,0.4,0.4) alarm[1]=60}
en5=instance_create(__view_get( e__VW.XView, 0)-64,240,oAlienRobot)
with en5 {image_xscale=1 canAttack=5 enemy_modify(my_pal_sprite,1,"DESTRON",0,0.4,0.4) alarm[1]=60}
