...
en2=instance_create_depth(8695+32,180,-1,oAlienRobot) en2.image_xscale=-1
...
with oAlienRobot 
{canmove=0 isIdle=1 alarm[1]=60 anim=70000 idleRange=30 enemyIdle1=StandSpr image_xscale=-1}
