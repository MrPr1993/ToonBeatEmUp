...
with en3 {enemy_switch("INVA",0) image_xscale=-1 canAttack=5 current_pal=1 alarm[1]=60 weapon_add("TASER")}
en4=instance_create(__view_get( e__VW.XView, 0)+320+64,244,oMartian)
with en4 {enemy_switch("INVA",0) image_xscale=-1 canAttack=5 current_pal=1 alarm[1]=60 weapon_add("TASER")}	
