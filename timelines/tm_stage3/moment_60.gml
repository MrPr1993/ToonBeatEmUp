...
oControl.Pshowhp[1]=0
with oControl
{current_pal=0;
my_pal_sprite=spr_enemypal
}

if global.StageRecord[2]!=1
{
...
////If it's the Airplane Stage
if global.StageRecord[2]=1
{
oControl.Penemyname[1]="CEILING"
timeline_position=159
}

////if it's the train crashing...
if global.StageRecord[2]=2
{
PlaySound(snd_train)
layer_background_sprite(back_id, bg_stage3c);

timeline_position=121
}
