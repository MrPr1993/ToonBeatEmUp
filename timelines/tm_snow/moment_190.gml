...
en2=instance_create(__view_get( e__VW.XView, 0)+320+64,210,oFairy)
...
en4=instance_create(__view_get( e__VW.XView, 0)+320+64,230,oFairy)
...
if playernumber>=3 {P2en2=instance_create(__view_get( e__VW.XView, 0)+320+64,250,oFairy)
