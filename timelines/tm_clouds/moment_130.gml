...
with en2 {image_xscale=-1 canAttack=5 alarm[1]=60 enemy_modify(my_pal_sprite,1,"WENDY",0,0.5,0.5)}	
...
with en4 {image_xscale=1 canAttack=5 alarm[1]=60 enemy_modify(my_pal_sprite,1,"WENDY",0,0.5,0.5)}	
