...
enA=instance_create(1260-48, 184+8,oNinjaBun) with enA
{canmove=0 anim=62}

en1=instance_create(1260, 184,oEnemy1) with en1
{canmove=0 isIdle=1 alarm[1]=60 anim=70002 idleRange=30 }
en2=instance_create(1260+80, 184,oEnemy1B) with en2
{canmove=0 isIdle=1 alarm[1]=60 anim=70002 idleRange=30 }
en3=instance_create(1260+80+80, 184,oEnemy1) with en3
{canmove=0 isIdle=1 alarm[1]=60 anim=70002 idleRange=30 }
