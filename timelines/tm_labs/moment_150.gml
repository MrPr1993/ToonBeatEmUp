...
with P2en1 {enemy_switch("DR.MONIA",0) image_xscale=1 canAttack=5 alarm[1]=60}}

if playernumber>=3 {P2en2=instance_create(__view_get( e__VW.XView, 0)-64,224-24,oNurse)
with P2en2 {enemy_switch("DR.MONIA",0) image_xscale=1 canAttack=5 alarm[1]=60}}

if playernumber>=4 {P2en3=instance_create(__view_get( e__VW.XView, 0)-64,224+24,oNurse)
with P2en3 {enemy_switch("DR.MONIA",0) image_xscale=1 canAttack=5 alarm[1]=60}}
////
}
else
{
