...
with P2en1 {current_pal=0; rangeX=0 image_xscale=1 spawnFall=spr_ladybot_charge	spawnEnemy=oLadybot canAttack=5 alarm[1]=60}}

if playernumber>=3 {P2en2=instance_create(__view_get( e__VW.XView, 0)+320-64,224,oEntryJump)
with P2en2 {current_pal=0; rangeX=0 image_xscale=-1 spawnFall=spr_ladybot_charge	spawnEnemy=oLadybot canAttack=5 alarm[1]=60}}

if playernumber>=4 {P2en3=instance_create(__view_get( e__VW.XView, 0)+320-64,270,oEntryJump)
with P2en3 {current_pal=0; rangeX=0 image_xscale=-1 spawnFall=spr_ladybot_charge	spawnEnemy=oLadybot canAttack=5 alarm[1]=60}}
////
