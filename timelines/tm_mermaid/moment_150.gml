...
en2=instance_create(4112+24,178,oMerman) en2.canmove=0 en2.isIdle=1 en2.alarm[1]=60 en2.anim=70000
en2.idleRange=30+24 en2.enemyIdle1=spr_merman_idle2 en2.enemyIdle2=spr_merman_attack
}
else
timeline_position-=1;