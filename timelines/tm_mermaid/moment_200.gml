...
en2=instance_create(__view_get( e__VW.XView, 0)-64,200+32,oLobster)
with en2 {image_xscale=1}

en3=instance_create(__view_get( e__VW.XView, 0)+320+64,200+32,oLobster)
with en3 {image_xscale=-1}

en4=instance_create(__view_get( e__VW.XView, 0)+320+64,200+32,oMerman)
