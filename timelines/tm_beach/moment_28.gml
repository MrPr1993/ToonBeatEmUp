...
{
en5=enemy_ambusher(0,176+240,oSwing,-1,1,32,10,1,1,0,1340)
with en5 {weapon_add("HANDGUN") enemy_switch("MS.TRIG",1)}

en6=enemy_ambusher(0,176+32+240,oSwing,-1,1,32,10,1,1,0,1340)
with en6 {weapon_add("HANDGUN") enemy_switch("MS.TRIG",1)}

en7=enemy_ambusher(0,176+64+240,oSwing,-1,1,32,10,1,1,0,1340)
