...
with en2{spawnX=0 zAppear=-128-128 spawnSpeedZMax=4 enemy_modify(my_pal_sprite,6,"MR. LAR",0,0.24,0.24)}
...
with en4{spawnX=0 zAppear=-128-128*3 spawnSpeedZMax=4 enemy_modify(my_pal_sprite,6,"MR. LAR",0,0.24,0.24)}
