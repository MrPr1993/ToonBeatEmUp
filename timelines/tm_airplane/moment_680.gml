...
en1=instance_create_depth(fakeen1.x,fakeen1.y,-1,oHarpyE) en1.z=fakeen1.z en1.alarm[0]=20 en1.alarm[1]=2;
en2=instance_create_depth(fakeen2.x,fakeen2.y,-1,oHarpyE) en2.z=fakeen2.z en2.alarm[0]=20 en2.alarm[1]=2;
