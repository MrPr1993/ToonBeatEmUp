...
{
enemySpawn0=1
en1=instance_create(__view_get( e__VW.XView, 0 )-64,208-16,oHarpyE) en1.canAttack=5 en1.alarm[0]=20 en1.alarm[1]=2;
en2=instance_create(__view_get( e__VW.XView, 0 )-64,208+16,oHarpyE) en2.canAttack=5 en2.alarm[0]=20 en2.alarm[1]=2;
