...
en9=instance_create(__view_get( e__VW.XView, 0)+320+64,208-16,oWrestler)
with en9 {image_xscale=-1 canAttack=5 alarm[1]=60}
en10=instance_create(__view_get( e__VW.XView, 0)+320+64,208+16,oWrestler)
with en10 {image_xscale=-1 canAttack=5 alarm[1]=60 enemy_switch("MS.CRUSH",0)}
