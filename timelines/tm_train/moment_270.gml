...
{
en1=instance_create(__view_get( e__VW.XView, 0 )-64,176,oSwing) with en1
{name="MS.HAMS" current_pal=4}
en2=instance_create(2063-112,124+29,oEntrySeat)
with en2 {trainFX=1 isDepth=0 depth=16777200 sittingSpr=spr_burglarB_ride spawnFall=spr_burglarB_jump rangeXAdd=0
...
with en4 {trainFX=1 isDepth=0 depth=16777200 sittingSpr=spr_femburglar_ride spawnFall=spr_femburglar_jump rangeXAdd=0
...
with en6 {trainFX=1 isDepth=0 sittingSpr=spr_sneak_seat spawnFall=spr_sneak_jump rangeXAdd=0
