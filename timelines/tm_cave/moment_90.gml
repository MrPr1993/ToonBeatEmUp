...
with P2en1 { current_pal=0; canAttack=5 alarm[1]=60 image_xscale=1}}

if playernumber>=3 {P2en2=instance_create(__view_get( e__VW.XView, 0 )+320+64, 240,oSkeleton)
with P2en2 { current_pal=0; canAttack=5 alarm[1]=60 image_xscale=-1}}

if playernumber>=4 {P2en3=instance_create(__view_get( e__VW.XView, 0 )+320+64, 260,oSkeleton)
with P2en3 { current_pal=0; canAttack=5 alarm[1]=60 image_xscale=-1}}
////
