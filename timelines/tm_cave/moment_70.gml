...
with en3 {image_xscale=1 canAttack=5 alarm[1]=60 enemy_switch("GOHNNY",0)
	weapon_add("PICKAXE")}

en4=instance_create(__view_get( e__VW.XView, 0)-64,220,oGoblin)
with en4 {image_xscale=1 canAttack=5 alarm[1]=60 enemy_switch("GOHNNY",0)
	weapon_add("PICKAXE")}	
...
with P2en2 {canAttack=5 alarm[1]=60 image_xscale=-1 enemy_switch("GOHNNY",0)
	weapon_add("PICKAXE")}}

if playernumber>=4 {P2en3=instance_create(__view_get( e__VW.XView, 0 )+320+64, 260,oGoblin)
with P2en3 {canAttack=5 alarm[1]=60 image_xscale=-1 enemy_switch("GOHNNY",0)
	weapon_add("PICKAXE")}}
////
